<x-guest-layout>
    ...
    <div class="container mx-auto w-full max-w-[85rem] mb-8 relative overflow-hidden  h-full  ">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
            ...
            <div class="flex justify-center">
                <a class="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 focus:outline-none focus:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:hover:border-neutral-600 dark:focus:border-neutral-600"
                    href="/listings">
                    This is an All in One template
                    <span
            ...
            <div class="mt-5 max-w-2xl text-center mx-auto p-4">
            ...
            <div class="mt-5 max-w-3xl text-center mx-auto">
                <p class="text-lg text-neutral-400">This is a website that helps me store all my components. It will
                    include all features from payments to blogs...You mane it!</p>
            </div>

            <div class="mt-8 gap-3 flex justify-center">
                <a class="button" class="flex items-center justify-center" href="#">
